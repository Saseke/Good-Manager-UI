...
- [Adding Bootstrap](#adding-bootstrap)
  - [Using a Custom Theme](#using-a-custom-goodTheme)
...
Import Bootstrap CSS and optionally Bootstrap goodTheme CSS in the beginning of your ```src/index.js``` file:

```js
import 'bootstrap/dist/css/bootstrap.css';
import 'bootstrap/dist/css/bootstrap-goodTheme.css';
...
* Add the necessary build steps to tweak the goodTheme, and publish your package on npm.
* Install your own goodTheme npm package as a dependency of your app.
